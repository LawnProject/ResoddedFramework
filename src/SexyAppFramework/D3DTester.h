...
class D3DTestImage
{
  ...
  public:
	...
	void DrawPieceToDevice(LPDIRECT3DDEVICE7 theDevice,
...
class D3DTester
{
  ...
  public:
	...
	bool HadWarning()
	{
		return !mWarning.empty();
	}
	bool HadError()
	{
		return !mFailureReason.empty();
	}
	bool Is3DSupported()
	{
		return !HadError();
	}
	bool Is3DRecommended()
	{
