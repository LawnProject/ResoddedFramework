...
bool D3DInterface::InitD3D()
{
	...
	if (CheckDXError(mD3D->CreateDevice(IID_IDirect3DHALDevice, mDDSDrawSurface, &mD3DDevice),
...
bool D3DInterface::InitFromDDInterface(DDInterface *theInterface)
{
	...
	if (CheckDXError(theInterface->mDrawSurface->QueryInterface(IID_IDirectDrawSurface7, (LPVOID *)&mDDSDrawSurface),
					 "Query DrawSurface"))
		return false;
...
bool D3DInterface::PreDraw()
{
	...
	if (!mSceneBegun)
	{
		...
		if (!SUCCEEDED(mD3DDevice->SetRenderTarget(
				mDDSDrawSurface,
				0))) // this happens when there's been a mode switch (this caused the nvidia screensaver bluescreen)
		{
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
static void CopyImageToTexture8888(void *theDest,
								   DWORD theDestPitch,
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
static void CopyImageToTexture4444(void *theDest,
								   DWORD theDestPitch,
								   MemoryImage *theImage,
								   int offx,
								   int offy,
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
static void CopyImageToTexture565(void *theDest,
								  DWORD theDestPitch,
								  MemoryImage *theImage,
								  int offx,
								  int offy,
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
static void CopyImageToTexturePalette8(void *theDest,
									   DWORD theDestPitch,
									   MemoryImage *theImage,
									   int offx,
									   int offy,
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
static void CopyTexturePalette8ToImage(void *theDest,
									   DWORD theDestPitch,
									   MemoryImage *theImage,
									   int offx,
									   int offy,
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
static void CopyImageToTexture(LPDIRECTDRAWSURFACE7 theTexture,
							   MemoryImage *theImage,
							   int offx,
							   int offy,
							   int texWidth,
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
LPDIRECTDRAWSURFACE7 TextureData::GetTexture(
	int x, int y, int &width, int &height, float &u1, float &v1, float &u2, float &v2)
{
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
LPDIRECTDRAWSURFACE7 TextureData::GetTextureF(
	float x, float y, float &width, float &height, float &u1, float &v1, float &u2, float &v2)
{
	int tx = x / mTexPieceWidth;
	int ty = y / mTexPieceHeight;
	...
	LPDIRECT3DDEVICE7 theDevice, float theX, float theY, const Rect &theSrcRect, const Color &theColor)
{
	...
	while (srcY < srcBottom)
	{
		...
		while (srcX < srcRight)
		{
			...
			D3DTLVERTEX aVertex[4] = {{x, y, 0, 1, aColor, 0, u1, v1},
			...
			D3DInterface::CheckDXError(theDevice->DrawPrimitive(D3DPT_TRIANGLESTRIP, gVertexType, aVertex, 4, 0),
									   "DrawPrimitive (Tri) 1");
...
static void DrawPolyClipped(LPDIRECT3DDEVICE7 theDevice, const Rect *theClipRect, const VertexList &theList)
{
	...
	if (aList.size() >= 3)
		D3DInterface::CheckDXError(theDevice->DrawPrimitive(D3DPT_TRIANGLEFAN, gVertexType, &aList[0], aList.size(), 0),
								   "DrawPrimitive (Tri) 2");
}
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void TextureData::BltTransformed(LPDIRECT3DDEVICE7 theDevice,
								 const SexyMatrix3 &theTrans,
								 ...
								 bool center)
{
	...
	while (srcY < srcBottom)
	{
		...
		while (srcX < srcRight)
		{
			...
			D3DTLVERTEX aVertex[4] = {{tp[0].x, tp[0].y, 0, 1, aColor, 0, u1, v1},
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void TextureData::BltTriangles(LPDIRECT3DDEVICE7 theDevice,
							   ...
							   float ty)
{
	...
	else
	{
		for (int aTriangleNum = 0; aTriangleNum < theNumTriangles; aTriangleNum++)
		{
			...
			D3DTLVERTEX aVertex[3] = {{aTriVerts[0].x + tx,
									   aTriVerts[0].y + ty,
									   0,
									   1,
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void D3DInterface::Blt(Image *theImage,
					   float theX,
					   float theY,
					   const Rect &theSrcRect,
					   const Color &theColor,
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void D3DInterface::BltMirror(Image *theImage,
							 float theX,
							 float theY,
							 const Rect &theSrcRect,
							 const Color &theColor,
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void D3DInterface::BltClipF(Image *theImage,
							float theX,
							float theY,
							const Rect &theSrcRect,
							const Rect *theClipRect,
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void D3DInterface::StretchBlt(Image *theImage,
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void D3DInterface::BltRotated(Image *theImage,
							  float theX,
							  float theY,
							  const Rect *theClipRect,
							  const Color &theColor,
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void D3DInterface::BltTransformed(Image *theImage,
								  const Rect *theClipRect,
								  const Color &theColor,
								  int theDrawMode,
								  const Rect &theSrcRect,
	...
	double theStartX, double theStartY, double theEndX, double theEndY, const Color &theColor, int theDrawMode)
{
	...
	D3DTLVERTEX aVertex[3] = {{x1, y1, 0, 1, aColor, 0, 0, 0},
	...
	D3DInterface::CheckDXError(mD3DDevice->DrawPrimitive(D3DPT_LINESTRIP, gVertexType, aVertex, 3, 0),
							   "DrawPrimitive (Line)");
}
...
void D3DInterface::FillRect(const Rect &theRect, const Color &theColor, int theDrawMode)
{
	...
	D3DTLVERTEX aVertex[4] = {{x, y, 0, 1, aColor, 0, 0, 0},
	...
	const TriVertex &p1, const TriVertex &p2, const TriVertex &p3, const Color &theColor, int theDrawMode)
{
	...
	DWORD aColor = RGBA_MAKE(theColor.mRed, theColor.mGreen, theColor.mBlue, theColor.mAlpha);
	D3DTLVERTEX aVertex[3] = {{p1.x, p1.y, 0, 1, GetColorFromTriVertex(p1, aColor), 0, 0, 0},
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void D3DInterface::FillPoly(const Point theVertices[],
							int theNumVertices,
							const Rect *theClipRect,
							const Color &theColor,
							int theDrawMode,
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void D3DInterface::DrawTriangleTex(const TriVertex &p1,
								   const TriVertex &p2,
								   const TriVertex &p3,
								   const Color &theColor,
								   int theDrawMode,
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void D3DInterface::DrawTrianglesTex(const TriVertex theVertices[][3],
									int theNumTriangles,
									const Color &theColor,
									int theDrawMode,
									Image *theTexture,
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void D3DInterface::DrawTrianglesTexStrip(const TriVertex theVertices[],
										 int theNumTriangles,
										 const Color &theColor,
										 int theDrawMode,
										 Image *theTexture,
